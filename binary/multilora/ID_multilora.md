...
| 适配器路径 | `Training/multi_lora/ID/lora_weights` |
| 适配器大小 | ~2MB (r=8) |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8211 | 0.6273 | **0.7113** | 322 |
| **violation** | 0.8909 | 0.9570 | **0.9228** | 1024 |

## 与 Full FT / LoRA 对比

| 指标 | Multi-LoRA | Full FT | Δ |
|------|-----------|---------|------|
| Accuracy | 0.8782 | 0.8568 | +0.0214 |
| Macro F1 | 0.8170 | 0.8568 | -0.0397 |
| Clean F1 | 0.7113 | 0.8562 | -0.1449 |
| Viol F1 | 0.9228 | 0.8573 | +0.0655 |
| **Viol Recall** | **0.9570** | **0.8660** | **+0.0910** |
| Clean Recall | 0.6273 | 0.8476 | -0.2203 |
...
model = PeftModel.from_pretrained(
    base,
    "/path/to/multi_lora/ID/lora_weights"
)
