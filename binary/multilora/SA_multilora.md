...
| 适配器路径 | `Training/multi_lora/SA/lora_weights` |
| 适配器大小 | ~2MB (r=8) |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8590 | 0.5154 | **0.6442** | 260 |
| **violation** | 0.9111 | 0.9832 | **0.9458** | 1313 |

## 与 Full FT / LoRA 对比

| 指标 | Multi-LoRA | Full FT | Δ |
|------|-----------|---------|------|
| Accuracy | 0.9059 | 0.8771 | +0.0288 |
| Macro F1 | 0.7950 | 0.8736 | -0.0786 |
| Clean F1 | 0.6442 | 0.8524 | -0.2081 |
| Viol F1 | 0.9458 | 0.8948 | +0.0510 |
| **Viol Recall** | **0.9832** | **0.8896** | **+0.0936** |
| Clean Recall | 0.5154 | 0.8594 | -0.3440 |
...
model = PeftModel.from_pretrained(
    base,
    "/path/to/multi_lora/SA/lora_weights"
)
