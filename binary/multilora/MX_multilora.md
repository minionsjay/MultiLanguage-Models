...
| 适配器路径 | `Training/multi_lora/MX/lora_weights` |
| 适配器大小 | ~2MB (r=8) |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.7768 | 0.5934 | **0.6729** | 305 |
| **violation** | 0.8862 | 0.9489 | **0.9165** | 1018 |

## 与 Full FT / LoRA 对比

| 指标 | Multi-LoRA | Full FT | Δ |
|------|-----------|---------|------|
| Accuracy | 0.8670 | 0.8633 | +0.0036 |
| Macro F1 | 0.7947 | 0.8504 | -0.0557 |
| Clean F1 | 0.6729 | 0.8944 | -0.2215 |
| Viol F1 | 0.9165 | 0.8064 | +0.1101 |
| **Viol Recall** | **0.9489** | **0.8381** | **+0.1108** |
| Clean Recall | 0.5934 | 0.8763 | -0.2829 |
...
model = PeftModel.from_pretrained(
    base,
    "/path/to/multi_lora/MX/lora_weights"
)
