...
| 模型路径 | `Training/adapter/ZA/adapter_weights` |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8585 | 0.9346 | **0.8949** | 1162 |
| **violation** | 0.5914 | 0.3806 | **0.4632** | 289 |

## 与 Full FT / Multi-LoRA 对比

| 指标 | Adapter | Full FT | Multi-LoRA | 最佳 |
|------|---------|---------|------------|------|
| Accuracy | 0.8243 | 0.8491 | 0.8243 | **Full FT** |
| Macro F1 | 0.6790 | 0.8412 | 0.6790 | **Full FT** |
| Clean F1 | 0.8949 | 0.8058 | 0.8949 | **Full FT** |
| Viol F1 | 0.4632 | 0.8766 | 0.4632 | **Full FT** |
| Viol Recall | 0.3806 | 0.8646 | 0.3806 | — |
| Clean Recall | 0.9346 | 0.8238 | 0.9346 | — |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/path/to/adapter/ZA/adapter_weights"
)
