...
| 模型路径 | `Training/adapter/ID/adapter_weights` |
| 可训参数 | 1,491,272 (0.5% of 279M) |
| 适配器大小 | ~2.5MB |
| 数据源 | data_v2/train_ID.csv |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8926 | 0.9580 | **0.9242** | 1024 |
| **violation** | 0.8259 | 0.6335 | **0.7170** | 322 |

## 与 Full FT / Multi-LoRA 对比

| 指标 | Adapter | Full FT | Multi-LoRA | 最佳 |
|------|---------|---------|------------|------|
| Accuracy | 0.8804 | 0.8568 | 0.8804 | **Full FT** |
| Macro F1 | 0.8206 | 0.8568 | 0.8206 | **Full FT** |
| Clean F1 | 0.9242 | 0.8562 | 0.9242 | **Full FT** |
| Viol F1 | 0.7170 | 0.8573 | 0.7170 | **Full FT** |
| Viol Recall | 0.6335 | 0.8660 | 0.6335 | — |
| Clean Recall | 0.9580 | 0.8476 | 0.9580 | — |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/path/to/adapter/ID/adapter_weights"
)
