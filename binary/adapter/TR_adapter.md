...
| 模型路径 | `Training/adapter/TR/adapter_weights` |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8667 | 0.9201 | **0.8926** | 926 |
| **violation** | 0.6797 | 0.5451 | **0.6050** | 288 |

## 与 Full FT / Multi-LoRA 对比

| 指标 | Adapter | Full FT | Multi-LoRA | 最佳 |
|------|---------|---------|------------|------|
| Accuracy | 0.8311 | 0.8621 | 0.8311 | **Full FT** |
| Macro F1 | 0.7488 | 0.8270 | 0.7488 | **Full FT** |
| Clean F1 | 0.8926 | 0.7491 | 0.8926 | **Full FT** |
| Viol F1 | 0.6050 | 0.9049 | 0.6050 | **Full FT** |
| Viol Recall | 0.5451 | 0.9013 | 0.5451 | — |
| Clean Recall | 0.9201 | 0.7572 | 0.9201 | — |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/path/to/adapter/TR/adapter_weights"
)
