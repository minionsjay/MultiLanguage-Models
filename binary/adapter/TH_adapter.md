...
| 模型路径 | `Training/adapter/TH/adapter_weights` |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8673 | 0.9620 | **0.9122** | 815 |
| **violation** | 0.8604 | 0.6141 | **0.7167** | 311 |

## 与 Full FT / Multi-LoRA 对比

| 指标 | Adapter | Full FT | Multi-LoRA | 最佳 |
|------|---------|---------|------------|------|
| Accuracy | 0.8659 | 0.8747 | 0.8659 | **Full FT** |
| Macro F1 | 0.8144 | 0.8675 | 0.8144 | **Full FT** |
| Clean F1 | 0.9122 | 0.8366 | 0.9122 | **Full FT** |
| Viol F1 | 0.7167 | 0.8984 | 0.7167 | **Full FT** |
| Viol Recall | 0.6141 | 0.8821 | 0.6141 | — |
| Clean Recall | 0.9620 | 0.8623 | 0.9620 | — |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/path/to/adapter/TH/adapter_weights"
)
