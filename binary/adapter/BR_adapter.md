...
| 模型路径 | `Training/adapter/BR/adapter_weights` |
...
|------|-----------|--------|------|--------|
| **clean (safe)** | 0.8648 | 0.9483 | **0.9046** | 1005 |
| **violation** | 0.7581 | 0.5224 | **0.6186** | 312 |

## 与 Full FT / Multi-LoRA 对比

| 指标 | Adapter | Full FT | Multi-LoRA | 最佳 |
|------|---------|---------|------------|------|
| Accuracy | 0.8474 | 0.8652 | 0.8474 | **Full FT** |
| Macro F1 | 0.7616 | 0.8288 | 0.7616 | **Full FT** |
| Clean F1 | 0.9046 | 0.9077 | 0.9046 | **Full FT** |
| Viol F1 | 0.6186 | 0.7500 | 0.6186 | **Full FT** |
| Viol Recall | 0.5224 | 0.8247 | 0.5224 | — |
| Clean Recall | 0.9483 | 0.8783 | 0.9483 | — |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/path/to/adapter/BR/adapter_weights"
)
