...
| 模型路径 | `Training/binary_8countries/TH_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.8124 | 0.8623 | **0.8366** | 879 |
| violation | 0.9154 | 0.8821 | **0.8984** | 1484 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/TH_fullft/final_model",
...
# 示例
text = "some Thailand text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/TH_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 2363 条
- clean (safe): 879 条 (37.2%)
- violation: 1484 条 (62.8%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Thailand 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [TH_lora.md](TH_lora.md)（更小更快，精度略低）
