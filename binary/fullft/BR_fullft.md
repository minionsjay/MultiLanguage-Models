...
| 模型路径 | `Training/binary_8countries/BR_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.9391 | 0.8783 | **0.9077** | 9868 |
| violation | 0.6876 | 0.8247 | **0.7500** | 3206 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/BR_fullft/final_model",
...
# 示例
text = "some Brazil text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/BR_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 13074 条
- clean (safe): 9868 条 (75.5%)
- violation: 3206 条 (24.5%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Brazil 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [BR_lora.md](BR_lora.md)（更小更快，精度略低）
