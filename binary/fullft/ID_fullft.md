...
| 模型路径 | `Training/binary_8countries/ID_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.8650 | 0.8476 | **0.8562** | 2441 |
| violation | 0.8488 | 0.8660 | **0.8573** | 2411 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/ID_fullft/final_model",
...
# 示例
text = "some Indonesia text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/ID_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 4852 条
- clean (safe): 2441 条 (50.3%)
- violation: 2411 条 (49.7%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Indonesia 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [ID_lora.md](ID_lora.md)（更小更快，精度略低）
