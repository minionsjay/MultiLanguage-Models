...
| 模型路径 | `Training/binary_8countries/ZA_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.7886 | 0.8238 | **0.8058** | 5261 |
| violation | 0.8890 | 0.8646 | **0.8766** | 8583 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/ZA_fullft/final_model",
...
# 示例
text = "some South Africa text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/ZA_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 13844 条
- clean (safe): 5261 条 (38.0%)
- violation: 8583 条 (62.0%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 South Africa 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [ZA_lora.md](ZA_lora.md)（更小更快，精度略低）
