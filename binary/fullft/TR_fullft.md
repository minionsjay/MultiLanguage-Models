...
| 模型路径 | `Training/binary_8countries/TR_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.7412 | 0.7572 | **0.7491** | 416 |
| violation | 0.9086 | 0.9013 | **0.9049** | 1114 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/TR_fullft/final_model",
...
# 示例
text = "some Turkey text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/TR_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 1530 条
- clean (safe): 416 条 (27.2%)
- violation: 1114 条 (72.8%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Turkey 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [TR_lora.md](TR_lora.md)（更小更快，精度略低）
