...
| Accuracy | **0.9185** |
| Macro F1 | **0.8807** |
| Macro Precision | 0.8782 |
| Macro Recall | 0.8833 |

| 类别 | Precision | Recall | F1 | Support |
|------|-----------|--------|------|--------|
| clean (safe) | 0.9503 | 0.9454 | **0.9479** | 11559 |
| violation | 0.8060 | 0.8211 | **0.8135** | 3192 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/SG_fullft/final_model",
...
# 示例
text = "some Singapore text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/SG_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 14751 条
- clean (safe): 11559 条 (78.4%)
- violation: 3192 条 (21.6%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Singapore 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [SG_lora.md](SG_lora.md)（更小更快，精度略低）
