...
| 模型路径 | `Training/binary_8countries/SA_fullft/final_model` |
| 模型大小 | 1.14 GB |
...
|------|-----------|--------|------|--------|
| clean (safe) | 0.8454 | 0.8594 | **0.8524** | 4830 |
| violation | 0.9001 | 0.8896 | **0.8948** | 6875 |
...
model = AutoModelForSequenceClassification.from_pretrained(
    "/home/ninini/Agents/Colloation_data/Training/binary_8countries/SA_fullft/final_model",
...
# 示例
text = "some Saudi Arabia text to classify"
...
classifier = pipeline(
    "text-classification",
    model="/home/ninini/Agents/Colloation_data/Training/binary_8countries/SA_fullft/final_model",
    tokenizer=tokenizer,
...
- 总计: 11705 条
- clean (safe): 4830 条 (41.3%)
- violation: 6875 条 (58.7%)

## 限制

- **仅二分类**: 不能区分违规类型（hate speech vs dangerous content vs harassment 等）
- **单国家**: 该模型仅针对 Saudi Arabia 内容，不适用于其他国家
- **需要多分类时**: 请使用 ID v5/v6 或 SA 多分类模型

## 相关模型

- LoRA 版本: [SA_lora.md](SA_lora.md)（更小更快，精度略低）
